...
@section('content')
    @include('admin::layouts.breadcrumb', $data = ['title' => 'Categorias', 'action' => 'Novo'])
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <select name="main" class="form-control" required="required">
                                    <option value="0" {{ @$request->main == 0 ? 'selected="selected"' : null }}>Não</option>
                                    <option value="1" {{ @$request->main == 1 ? 'selected="selected"' : null }}>Sim</option>
                                </select>
                            </div>
                        </div>
